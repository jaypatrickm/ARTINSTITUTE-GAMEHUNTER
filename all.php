...
<title>Game Hunter -- All Games</title>
...
<div id="container">
   ...
   <div id="all_middle">
    <div id="huntingFieldLeft">
        ...
        <ul id="huntingLeftPlayers">
        	<li class="leftHeadline">Players</li>
            <li>Single Player</li>
        	<li>Two Player</li>
        	<li>Multiplayer</li>
        </ul>
    ...
    <div id="pageTitle">
    	<p id="pageTitleText">ALL</p>
        <ul id="pageBreadcrumb">
        <li>Games</li>
        </ul>
...
#################################################
		...
		//echo $currentProd_id;
			...
			echo '<h2><a href="testingdetails.php?product_id=' . $row['product_id']. '"><span id="productTitle">' . $row['title'] . '</span></a></h2>';
