...
<title>Game Hunter -- PSP Games</title>
<script type="text/javascript" src="js/jquery-1.7.1.min.js"></script>
<script type="text/javascript" src="js/jquery.cycle.all.js"></script>
<script type="text/javascript" src="js/jquery.validate.min.js"></script>
<script type="text/javascript">
$(document).ready(function(){
	$('#pspNav').show( function(){
		$('#subNav').css('background-color', '#963535'),
		$('#huntingFieldLeft').css('background-color', '#963535'),
		$('.thickHR').css('color','#963535'),
		$('.thickHR').css('background-color', '#963535'),
		$('.productTitle').css('border-bottom-color','#963535')});
...
<body id="xbox360Index">
    ...
    <div id="pageTitle">
    	<p id="pageTitleText">PSP</p>
        <ul id="pageBreadcrumbPsp">
        <li>Games</li>
        </ul>
...
#################################################	
	...
	$sql = "SELECT * FROM product, platform, product_platform_lookup
			...
			AND product_platform_lookup.platform_id = 5";
...
### start if $start_number
	if ($start_number >= 0) {
		...
		$sql = "SELECT count(*) 
				...
				WHERE product_platform_lookup.platform_id = 5";
