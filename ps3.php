...
<title>Game Hunter -- PS3 Games</title>
<script type="text/javascript" src="js/jquery-1.7.1.min.js"></script>
<script type="text/javascript" src="js/jquery.cycle.all.js"></script>
<script type="text/javascript" src="js/jquery.validate.min.js"></script>
<script type="text/javascript">
$(document).ready(function(){
	$('#ps3Nav').show( function(){
		$('#subNav').css('background-color', '#354e96'),
		$('#huntingFieldLeft').css('background-color', '#354e96'),
		$('.thickHR').css('color','#354e96'),
		$('.thickHR').css('background-color', '#354e96'),
		$('.productTitle').css('border-bottom-color','#354e96')});
...
<body id="xbox360Index">
    ...
    <div id="pageTitle">
    	<p id="pageTitleText">PS3</p>
        <ul id="pageBreadcrumbPs3">
        <li>Games</li>
        </ul>
