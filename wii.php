...
<title>Game Hunter -- Wii Games</title>
<script type="text/javascript" src="js/jquery-1.7.1.min.js"></script>
<script type="text/javascript" src="js/jquery.cycle.all.js"></script>
<script type="text/javascript" src="js/jquery.validate.min.js"></script>
<script type="text/javascript">
$(document).ready(function(){
	$('#wiiNav').show( function(){
		$('#subNav').css('background-color', '#359096'),
		$('#huntingFieldLeft').css('background-color', '#359096'),
		$('.thickHR').css('color','#359096'),
		$('.thickHR').css('background-color', '#359096'),
		$('.productTitle').css('border-bottom-color','#359096')});
...
<body id="xbox360Index">
    ...
    <div id="pageTitle">
    	<p id="pageTitleText">Wii</p>
        <ul id="pageBreadcrumbWii">
        <li>Games</li>
        </ul>
...
#################################################	
	...
	$sql = "SELECT * FROM product, platform, product_platform_lookup
			...
			AND product_platform_lookup.platform_id = 3";
...
### start if $start_number
	if ($start_number >= 0) {
		...
		$sql = "SELECT count(*) 
				...
				WHERE product_platform_lookup.platform_id = 3";
